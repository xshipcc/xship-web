...
class MeasureTriangle extends BaseMeasure {
  ...
  createLabels() {
    ...
    //高度差
    var height = Math.abs(
      Cesium.Cartographic.fromCartesian(that.highPosition).height -
        Cesium.Cartographic.fromCartesian(that.lowPosition).height,
    );
    var height_mid = Cesium.Cartesian3.midpoint(
      that.lowPosition,
      that.midPosition,
    ...
    var horizon_mid = Cesium.Cartesian3.midpoint(
      that.highPosition,
      that.midPosition,
      new Cesium.Cartesian3(),
    );
    ...
    var space_mid = Cesium.Cartesian3.midpoint(
      that.endPosition,
      that.firstPosition,
      new Cesium.Cartesian3(),
    );
