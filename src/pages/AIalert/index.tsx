...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<ListAlertHistoryData>[] = [
    ...
    // ],
    {
      ...
      dataIndex: 'type',
      valueEnum: {
        0: { text: '人员', color: '#282c34' },
        1: { text: '车辆', color: '#4d78cc' },
        2: { text: '自行车', color: '#d4504d' },
        3: { text: '汽车', color: '#8b8d8a' },
        4: { text: '卡车', color: '#8b8d8a' },
        5: { text: '厢式货车', color: '#8b8d8a' },
        6: { text: '三轮车', color: '#8b8d8a' },
        7: { text: '摩托车', color: '#8b8d8a' },
        8: { text: '烟雾', color: '#8b8d8a' },
        9: { text: '火警', color: '#8b8d8a' },
      },
    },
    // {
    //   title: '系统分类二级类别',
