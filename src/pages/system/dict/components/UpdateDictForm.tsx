 ...
 * @LastEditTime: 2024-01-31 19:22:00
 * @FilePath: \zero-admin-ui-master\src\pages\system\dict\components\UpdateDictForm.tsx
 * @Description:
 *
...
const UpdateDictForm: React.FC<UpdateFormProps> = (props) => {
  ...
  return (
    <Modal forceRender destroyOnClose title="修改字典" open={updateModalVisible} {...modalFooter}>
