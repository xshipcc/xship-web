      ...
      {item.status !== 3 && (
        <>
          ...
          <Row>
            ...
            <Col span={18} className={'Col'}>
              {companyAddressItem?.province} {companyAddressItem?.city} {companyAddressItem?.region}
            </Col>
          </Row>
          <Row>
            <Col span={6} className={'Col'}>
            ...
            <Col span={18} className={'Col'}>
              {companyAddressItem?.detailAddress}
            </Col>
          </Row>
          <Row>
            <Col span={6} className={'Col'}>
